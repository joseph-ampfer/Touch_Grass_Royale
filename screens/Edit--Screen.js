...
import { changePassword, updateProfile } from "../apiFetches/fetches";
        ...
        {fieldType == "Email" ? (
          ...
          <View style={tw`flex-row items-center ml-3 mt-4 `}>
            ...
            <Text style={tw`text-white text-2xl font-bold ml-6`}>
              {fieldType == "full_name" ? "Name" : fieldType}
            </Text>
            <TouchableOpacity
              style={tw`absolute right-5`}
              onPress={() =>
                updateFn.mutate({ [fieldType.toLowerCase()]: userInput })
              }
            >
              <Ionicons name="checkmark" size={34} style={tw`text-blue-600 `} />
            </TouchableOpacity>
          ...
          <View style={tw`flex-col mx-5 mt-10`}>
            ...
            <View style={tw``}>
              <Text style={tw`text-white/50 `}>
                For if you forget your password.
              </Text>
            </View>
          </View>
        ) : fieldType == "Password" ? (
          ...
          <View style={tw`flex-col mx-5 mt-10`}>
            ...
            <View style={tw``}>
              {fieldType == "full_name" ? (
                ...
                <Text style={tw`text-white/50 `}>
                  Update your username to something cool.
                </Text>
              )}
            </View>
          </View>
