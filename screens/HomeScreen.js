          ...
          <View style={tw``}>
            <View style={tw`flex-row justify-between`} >
              ...
              <View style={tw`flex-2 justify-center`}>
                <Text style={tw`font-bold text-lg text-white mr-5 `}> Winning with {data[0].time} </Text>
                <Text style={tw`font-bold text-lg text-white mr-5 `}> points, catch up!</Text>
              </View>
            </View>
          </View>
        </View>
          ...
          <View style={tw`mt-5 flex-row mx-5 justify-between`}>
            ...
            <View style={[tw`h-29 w-45 flex rounded-3xl justify-center`, {backgroundColor: 'rgba(255,255,255,0.2)'}]}>
              <View style={tw`flex-row justify-center items-center`}>
                ...
                <View>
                  <Text style={tw`flex text-wrap font-semibold text-white/50 ml-2 text-lg`}>hours</Text>
                  <Text style={tw`flex text-wrap font-semibold text-white/50 ml-2 mr-2 text-left`}>remaining</Text>
                </View>
              </View>
            </View>
          </View>
